...
public class AgentConfigPanel extends JPanel implements FocusListener
{
    ...
    public AgentConfigPanel()
    {
        ...
        layout.putConstraint(SpringLayout.WEST, next_product_config, 0, SpringLayout.WEST, textfield[0]);
        layout.putConstraint(SpringLayout.NORTH, next_product_config, 5, SpringLayout.SOUTH, textfield[textfield.length - 1]);
