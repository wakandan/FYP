...
public class SimConfigPanel extends JPanel implements FocusListener {
	...
	String[]		labels		= { "Credit Per Turn:", "Agent Config Class:",
			"Agent Config File:", "Product Config File:", "Agent Master Config File:",
	...
	public SimConfigPanel() {
		...
		layout.putConstraint(SpringLayout.WEST, next_agent_config, 0, SpringLayout.WEST,
				textfield[0]);
		layout.putConstraint(SpringLayout.NORTH, next_agent_config, 5, SpringLayout.SOUTH,
