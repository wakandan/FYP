...
public class SchedConfigPanel extends JPanel implements FocusListener {
	...
	public SchedConfigPanel() {
		...
		layout.putConstraint(SpringLayout.WEST, next_master_config, 0, SpringLayout.WEST,
				textfield[0]);
		layout.putConstraint(SpringLayout.NORTH, next_master_config, 5, SpringLayout.SOUTH,
