...
public class ProductConfigPanel extends JPanel implements FocusListener {
	...
	public ProductConfigPanel() {
		...
		textfield[8]
				.setText("<For Example: src/test/resources/configbase/testNormalDistributionConfig.ini");
		...
		layout.putConstraint(SpringLayout.WEST, next_sched_config, 0, SpringLayout.WEST,
				textfield[0]);
		layout.putConstraint(SpringLayout.NORTH, next_sched_config, 5, SpringLayout.SOUTH,
